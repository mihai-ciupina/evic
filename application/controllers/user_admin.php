...
Class User_admin extends CI_Controller {
	...
	public function show_users_search_result() {
		...
		$this->form_validation->set_rules('name', 'Nume utilizator: ', 'trim|xss_clean');
...
public function vardump(&$_var, &$aDefinedVars = null){
	...
	public function user_update() {
		...
		$this->form_validation->set_rules('user_name', 'Username utilizator', 'trim|required|xss_clean|min_length[5]');
	...
	public function user_insert() {
		...
		//check validation for user
		$this->form_validation->set_rules('user_name', 'Nume utilizator', 'trim|required|xss_clean|min_length[5]');
		$this->form_validation->set_rules('category', 'Categorie', 'trim|required|xss_clean');
		$this->form_validation->set_rules('user_password', 'Parola', 'trim|required|xss_clean|min_length[1]');
		$this->form_validation->set_rules('user_password_again', 'Parola', 'trim|required|xss_clean|min_length[1]');
