						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'name', 'value' => set_value('name', (isset($result) ? $result[0]->name : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
										...
										<span id="<?=$dependent_name[0]?>_span" class="span10">
											<?php
												if($dependent_name[0] != '') {
													...
													$data['field_value'] = $dependent_value[0];
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'category', 'value' => set_value('name', (isset($result) ? $result[0]->category : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
										...
										<span id="<?=$dependent_name[1]?>_span" class="span10">
											<?php
												if($dependent_name[1] != '') {
													...
													$data['field_value'] = $dependent_value[1];
													$this->load->view('dynamic_dropdown', $data);
													$this->load->view('modal_window', $data);
												}
											?>
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php //echo form_input(array('name' => 'status', 'value' => set_value('status', (isset($result) ? $result[0]->status : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										...
										<span id="<?=$dependent_name[2]?>_span" class="span10">
											<?php
												if($dependent_name[2] != '') {
													...
													$data['field_value'] = $dependent_value[2];
													$this->load->view('dynamic_dropdown', $data);
													$this->load->view('modal_window', $data);
												}
											?>
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'compatibility', 'value' => set_value('compatibility', (isset($result) ? $result[0]->compatibility : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
										...
										<span id="<?=$dependent_name[3]?>_span" class="span10">
											<?php
												if($dependent_name[3] != '') {
													...
													$data['field_value'] = $dependent_value[3];
													$this->load->view('dynamic_dropdown', $data);
													$this->load->view('modal_window', $data);
												}
											?>
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'provenience', 'value' => set_value('provenience', (isset($result) ? $result[0]->provenience : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
										...
										<span id="<?=$dependent_name[4]?>_span" class="span10">
											<?php
												if($dependent_name[4] != '') {
													...
													$data['field_value'] = $dependent_value[4];
													$this->load->view('dynamic_dropdown', $data);
													$this->load->view('modal_window', $data);
												}
											?>
										...
										<span id="<?=$dependent_name[5]?>_span" class="span10">
											<?php
												if($dependent_name[5] != '') {
													...
													$data['field_value'] = $dependent_value[5];
													$this->load->view('dynamic_dropdown', $data);
													$this->load->view('modal_window', $data);
												}
											?>
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'product_code', 'value' => set_value('product_code', (isset($result) ? $result[0]->product_code : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'location', 'value' => set_value('location', (isset($result) ? $result[0]->location : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'unit', 'value' => set_value('unit', (isset($result) ? $result[0]->unit : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'unit_quantity', 'value' => set_value('unit_quantity', (isset($result) ? $result[0]->unit_quantity : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'quantity', 'value' => set_value('quantity', (isset($result) ? $result[0]->quantity : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'unit_price', 'value' => set_value('unit_price', (isset($result) ? $result[0]->unit_price : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_textarea(array('name' => 'notes', 'value' => set_value('notes', (isset($result) ? $result[0]->notes : '') ), 'id' => '', 'class' => 'input-large nameField', 'rows' => 10, 'cols' => 50)) ?>
										</span>
									</div>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" colspan="3">
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'url', 'value' => set_value('url', (isset($result) ? $result[0]->url : '') ), 'id' => '', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
