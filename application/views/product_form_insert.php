	...
	if(!isset($category_page)) {
        ...
        <div class="contentsDiv marginLeftZero" id="rightPanel" style="min-height:550px;">
			<div class='container-fluid editViewContainer'>
					...
					<?php echo form_open_multipart('product/product_insert', array('class' => 'form-horizontal recordEditView', 'enctype' => 'multipart/form-data'));?>
					...
					<table class="table table-bordered blockContainer showInlineTable equalSplit">
						...
						<tbody>
							<tr>
								...
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[0]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php //echo form_input(array('name' => 'category', 'value' => set_value('category', $category), 'id' => 'category', 'class' => 'input-large nameField', 'disabled' => 'disabled')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[1]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_dropdown('status', array(''=>'Alegeti o varianta','new'=>'Nou','second'=>'Second'), set_value('status'));?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[2]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'compatibility', 'value' => set_value('compatibility'), 'id' => 'compatibility', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[3]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
							...
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'provenience', 'value' => set_value('provenience'), 'id' => 'provenience', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[4]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
							...
							<tr>
								...
								<td class="fieldLabel medium">
									<?php echo form_label($dependent_label[5]);?>
								</td>
								<td class="fieldValue medium" >
									<div class="row-fluid">
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'product_code', 'value' => set_value('product_code'), 'id' => 'product_code', 'class' => 'input-large nameField', 'disabled' => 'disabled')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'location', 'value' => set_value('location'), 'id' => 'location', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php //echo form_input(array('name' => 'unit', 'value' => set_value('unit'), 'id' => 'unit', 'class' => 'input-large nameField')) ?>
											<?php echo form_dropdown('unit', array(''=>'Alegeti o varianta', 'each'=>'Bucata', 'pack'=>'Pachet', 'box'=>'Cutie', 'weight'=>'Grame', 'centimeters'=>'Centimetri', 'ml'=>'Mililitri', 'pages'=>'Pagini', 'sheet'=>'foi'), set_value('unit'), 'id="unit"');?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'unit_quantity', 'value' => set_value('unit_quantity', 1), 'id' => 'unit_quantity', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'quantity', 'value' => set_value('quantity'), 'id' => 'quantity', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'unit_price', 'value' => set_value('unit_price'), 'id' => 'unit_price', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo "<input type='file' name='product_image_file' size='20' />"; ?>
										</span>
									</div>
								</td>
								<td class="fieldLabel medium">
								...
								<td class="fieldValue medium" >
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_textarea(array('name' => 'notes', 'value' => set_value('notes'), 'id' => 'notes', 'class' => 'input-large nameField', 'rows' => 10, 'cols' => 50)) ?>
										</span>
									</div>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td class="fieldValue medium" colspan="3">
									<div class="row-fluid">
										<span class="span10">
											<?php echo form_input(array('name' => 'url', 'value' => set_value('url'), 'id' => 'url', 'class' => 'input-large nameField')) ?>
										</span>
									</div>
								</td>
							</tr>
					...
					<br />
				<?php if(isset($category_page)){echo form_hidden('category', $category_page);}?>				
				<?php echo form_close();?>
			</div>
		</div>
	<?php
